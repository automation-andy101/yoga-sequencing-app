    ...
    return (
        <article className="rounded-2xl border bg-white p-5 shadow-sm">
            <div className="mb-4">
                ...
                <span className="rounded-full bg-gray-100 px-2 py-1">
                    {classTemplate.sections.length} sections
                </span>
                </div>
            </div>

            <Link
                href={`/class-templates/${classTemplate._id}`}
        ...
        //         <Link
        //             href={`/class-templates/${classTemplate._id}`}
        //             className="inline-flex rounded-xl bg-black px-4 py-2 text-sm font-medium text-white transition hover:bg-gray-800"
        //         >
        //             View Class
        //         </Link>
        //     </div>
